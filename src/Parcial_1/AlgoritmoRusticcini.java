...
public class AlgoritmoRusticcini implements AlgoritmoConcurrencia {
    private Queue<Proceso> colaProcesos; // Cola de procesos

    // Constructor
    public AlgoritmoRusticcini() {
    ...
    public void iniciarSimulacion(List<Proceso> procesos) {
        System.out.println("Iniciando simulación con AlgoritmoRusticcini..."); // Imprime mensaje de inicio de simulación
    ...
    public void obtenerResultados() {
        System.out.println("Obteniendo resultados de la simulación con AlgoritmoRusticcini..."); // Imprime mensaje de obtención de resultados
